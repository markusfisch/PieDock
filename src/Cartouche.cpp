 ...
 */
void Cartouche::drawRectangle( int left, int top, int right, int bottom, 
	unsigned int color )
{
 ...
 * @param color - color of rectangle
 */
void Cartouche::drawRoundedRectangle( int left, int top, int right, int bottom, 
